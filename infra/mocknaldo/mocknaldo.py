...
def simulate_score(minute, match):
    prob_home, prob_draw, prob_away = odds_to_probabilities(match["home_odds"], match["tie_odds"], match["away_odds"])
...
def simulate_cards(match):
    home_prob, _, away_prob = odds_to_probabilities(match["home_odds"], match["tie_odds"], match["away_odds"])
        ...
        if active:
            ...
            for match in MATCHES:
                ...
                if current > match["started_at"]:
                    ...
                    match["awat_penalties"] = new_away_penalties
                    MATCHES_LOCK.release()
